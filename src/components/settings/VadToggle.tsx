...
export function VadToggle({ value, onChange }: VadToggleProps) {
  return (
    <div className="flex items-center justify-between gap-4 min-h-[44px]">
      <div>
        <p className="text-base text-text-primary font-medium">VAD Filter</p>
        <p className="text-xs text-text-muted mt-0.5">Strip silence from recordings</p>
      </div>
      <button
        type="button"
        role="switch"
